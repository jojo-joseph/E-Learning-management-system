...
$query=mysql_query("update university set uname='$uname',contactno='$contactno',address='$address',state='$state',country='$country',pincode='$pincode' where uemail='".$_SESSION['login']."'");
if($query)
{
...
<b>Well done!</b> <?php echo htmlentities($successmsg);?></div>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <?php }?>
 <?php $query=mysql_query("select * from university where uemail='".$_SESSION['login']."'");
