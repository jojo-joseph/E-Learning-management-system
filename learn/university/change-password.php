...
{
$sql=mysql_query("SELECT password FROM  university where password='".md5($_POST['password'])."' && uemail='".$_SESSION['login']."'");
$num=mysql_fetch_array($sql);
if($num>0)
{
 $con=mysql_query("update university set password='".md5($_POST['newpassword'])."', updationdate='$currentTime' where uemail='".$_SESSION['login']."'");
