...
{
$ret=mysql_query("SELECT * FROM university WHERE uemail='".$_POST['uemail']."' and ( password='".md5($_POST['password'])."' and apstatus='approved')");
...
$status=1;
$log=mysql_query("insert into universitylog(uid,username,userip,status) values('".$_SESSION['id']."','".$_SESSION['login']."','$uip','$status')");
...
$uip=$_SERVER['REMOTE_ADDR'];
$status=0;
mysql_query("insert into universitylog(username,userip,status) values('".$_SESSION['login']."','$uip','$status')");
